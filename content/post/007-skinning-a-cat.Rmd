...
Let's run though the options.  (The discussion that follows here will stick to the broad principles involved.  For details, see the [water and sodium pages](/books/NEPHROMATHS/water-and-sodium) of "Nephromaths".)  
...
2) Check UOsm and UNa - and interpret as [here](/books/NEPHROMATHS/water-and-sodium#hyponatraemia).  Often helpful in diagnosing the *cause* of hyponatraemia.  

3) Calculate the urine:plasma electrolyte ratio - and interpret as [here](/books/NEPHROMATHS/water-and-sodium#free-water-clearance).  Often useful to set an approximate starting water restriction (e.g. in SIADH).  

4) Consider - broadly - whether other sources of free water and cation input / output need to be factored in.  Use this to revise any fluid restriction and consider whether salt or protein supplementation is required.  Interpret solute intake in the context of [normal dietary content](/books/NEPHROMATHS/general-approach-to-a-patient-with-electrolyte-disturbance#iv-fluids-electrolyte-supplements).  
